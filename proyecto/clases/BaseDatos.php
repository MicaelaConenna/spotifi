...
public $conexion;
	...
	public function registrarUsuario($new_nombre,$new_clave,$new_email,$new_latitud,$new_longitud,$new_es_admin,$new_esta_bloqueado, $tk){
		...
		$sql="insert into Usuario (nombre,clave,email,latitud,longitud,es_admin,esta_bloqueado, token)
			  values ('$new_nombre','$clave','$new_email','$new_latitud','$new_longitud',$new_es_admin,$new_esta_bloqueado, '$tk')";
